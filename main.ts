...
sprites.onOverlap(SpriteKind.PlayerShot, SpriteKind.miniboss, function (sprite, otherSprite) {
    ...
    statusbars.getStatusBarAttachedTo(StatusBarKind.minibosshealth, otherSprite).value += -10
})
